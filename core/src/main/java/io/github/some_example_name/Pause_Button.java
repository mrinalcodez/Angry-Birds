...
public class Pause_Button implements Button_Interface, Serializable {
    ...
    public Pause_Button(String path, int x, int y, int width, int height, float size, SerializableRenderer renderer, SerializableInputMultiplexer multiplexer) {
        this.size = size;
    ...
    public void setPosition(float x, float y) {
        button_texture.setPosition(x, y - button_texture.height);
    ...
    @Override
    public void draw(SerializableRenderer serializableRenderer) {
        if(isButtonVisible) {
            button_texture.draw(serializableRenderer, button_texture.x, button_texture.y, button_texture.width, button_texture.height, button_texture.rotation);
        }
    }
